package net.quantium.projectsuperposition.protection.electriccoil.client;
...
public class RendererCoil extends TileEntitySpecialRenderer {
    ...
    private final ModelCoil modelbase;
	private ResourceLocation textures = new ResourceLocation(ModProvider.MODID + ":textures/blocks/coil.png");
    public static RendererCoil INSTANCE = new RendererCoil();
    
    public RendererCoil() {
    	this.modelbase = new ModelCoil();        
    }
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        this.modelbase.render((Entity)null, 0f, 0f, 0f, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
