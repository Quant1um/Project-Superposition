...
import net.quantium.projectsuperposition.debug.network.CaptureResponseMessage;
 ...
 *
 * @author CoolAlias
 * I don't remember where i got this code, but author of this class is definitely CoolAlias
 */
 ...
 */
 private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(ModProvider.MODID);
 ...
 */
 ...
 // It's even easier if you create a convenient 'registerMessage' method:
	 	...
	 	PacketDispatcher.registerMessage(TextUpdateMessage.Handler.class, TextUpdateMessage.class, Side.SERVER);
	 	PacketDispatcher.registerMessage(CreateMessage.Handler.class, CreateMessage.class, Side.SERVER);
	 	PacketDispatcher.registerMessage(ParticleMessage.Handler.class, ParticleMessage.class, Side.CLIENT);
	 	PacketDispatcher.registerMessage(ParticleLineMessage.Handler.class, ParticleLineMessage.class, Side.CLIENT);
	 	PacketDispatcher.registerMessage(GetOwnerMessage.Handler.class, GetOwnerMessage.class, Side.CLIENT);
 
	 	PacketDispatcher.registerMessage(CaptureRequestMessage.Handler.class, CaptureRequestMessage.class, Side.SERVER);
	 	PacketDispatcher.registerMessage(CaptureResponseMessage.Handler.class, CaptureResponseMessage.class, Side.CLIENT);
	 	//PacketDispatcher.registerMessage(SorterUpdateMessage.Handler.class, SorterUpdateMessage.class, Side.SERVER);
 //PacketDispatcher.registerMessage(QuantiumInventoryMessage.Handler.class, QuantiumInventoryMessage.class, Side.SERVER);
 //PacketDispatcher.registerMessage(CaseValidationMessage.Handler.class, CaseValidationMessage.class, Side.SERVER);
